...
import VideoHisRus7Class.VideoHisRus7_part2;

public class TestHisRus7_part2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_his_rus7_part2);
