...
import VideoInfor5Class.VideoInfor5_part2;

public class TestInfor5_part2 extends AppCompatActivity {

    int[] correctAnswers = {
            R.id.q1a, R.id.q2b, R.id.q3b, R.id.q4b, R.id.q5b,
            R.id.q6a, R.id.q7b, R.id.q8a, R.id.q9b, R.id.q10a,
            R.id.q11a, R.id.q12a, R.id.q13a, R.id.q14b, R.id.q15a
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_infor5_part2);
