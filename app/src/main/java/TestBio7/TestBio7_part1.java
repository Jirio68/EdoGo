...
import VideoBio7Class.VideoBio7_part2;

public class TestBio7_part1 extends AppCompatActivity {

    int[] correctAnswers = {
            R.id.q1a, R.id.q2a, R.id.q3a, R.id.q4a, R.id.q5b,
            R.id.q6a, R.id.q7a, R.id.q8a, R.id.q9a, R.id.q10b,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_bio7_part1);
